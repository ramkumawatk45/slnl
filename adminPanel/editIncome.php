...
if(isset($_REQUEST['editAccounting']))
{
	...
	$sql=mysql_query("UPDATE income_expenses SET createDate='$joincDate', name='$incomeName', remarks='$remarks',penaltyAmount='$penaltyAmount',serviceCharges='$serviceCharges', insuranceCharges='$insuranceCharges',loanSavings='$loanSavings' WHERE id='$id'");
              ...
              <!-- general form elements -->
				...
				<?php $query = "SELECT * FROM income_expenses where id='$id'";
                 ...
                 <div class="box-body">
						...
						<input type="text" class="form-control" id="incomeName" name="incomeName" value="<?php echo $loanData['name']; ?>" maxlength="50"  required />                  
						</div>
						<div class="form-group col-md-2">
						<label for="pageTitle">Penalty Amount <span class="requiredField">*</span>  </label>
						<input type="text" class="form-control digitsOnly" id="penaltyAmount" name="penaltyAmount" value="<?php echo $loanData['penaltyAmount']; ?>" maxlength="10" required />                  
						</div>
						<div class="form-group col-md-2">
						<label for="pageTitle">Insurance Charges <span class="requiredField">*</span>  </label>
						<input type="text" class="form-control digitsOnly" id="insuranceCharges" name="insuranceCharges" value="<?php echo $loanData['insuranceCharges']; ?>" maxlength="10" required />          </div>
						<div class="form-group col-md-2">
						<label for="pageTitle">Loan Savings <span class="requiredField">*</span>  </label>
						<input type="text" class="form-control digitsOnly" id="loanSavings" name="loanSavings" value="<?php echo $loanData['loanSavings']; ?>" maxlength="10" required />                  
						</div>				
						<div class="form-group col-md-4">
						  <label for="pageTitle">Remarks </label>
						  <input type="text" class="form-control" id="remarks" name="remarks" placeholder="Remarks" value="<?php echo $loanData['remarks']; ?>" maxlength="100" />   </div>
                  </div><!-- /.box-body -->
				  <?php 
					}
					?>
