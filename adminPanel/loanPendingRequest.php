...
<script type="text/javascript">
	...
	var pagePrintTitle = "Loan Customer Pending Requests List"	
    $('#example').DataTable( {
        dom: 'Bfrtip',
        buttons: [
				'pageLength',
              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <table id="example" class="table table-bordered table-striped " cellspacing="0" width="100%">
					...
					{
						$query="SELECT * FROM loanrequests where requestStatus='Pending' and deleted='0' order by id Desc  ";
					}
					else
					{
							$query=" SELECT * FROM loanrequests where branchCode='$branchId' and requestStatus='Pending'  and  deleted='0' order by id Desc";
					}	
