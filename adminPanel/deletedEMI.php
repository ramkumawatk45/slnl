            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Deleted EMI list</h3>
                </div><!-- /.box-header -->
                <div class="box-body ">
                  <table id="emiReport" class="table table-bordered table-striped">
                   <thead>
					...
					<?php
						...
						{
							$query=" SELECT * FROM loans inner join loanemi on loans.loanId=loanemi.loanId and loanemi.deleted='1'and loans.deleted='0'";
						}
						else
						{
						...
						<tr>
							...
							{  echo $branchData['branchName']." - ".$branchData['branchCode']; } ?> </td>
								...
								<td><?php echo $tableData['datetime']; ?> </td>
						  </tr>
