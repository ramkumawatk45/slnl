...
<script type="text/javascript">
 function sortTableData()
 {
	...
	var pagePrintTitle = "Income List"	
    $('#example').DataTable( {
        dom: 'Bfrtip',
        buttons: [
				'pageLength',
		...
		"footerCallback": function ( row, data, start, end, display ) {
			...
			serviceChargesTotal = api
                .column( 3, { page: 'current'} )
                .data()
                .reduce( function (a, b) {
                    return intVal(a) + intVal(b);
                }, 0 );
			insuranceChargeTotal = api
                .column( 4, { page: 'current'} )
                .data()
                .reduce( function (a, b) {
                    return intVal(a) + intVal(b);
                }, 0 );
			loanSavingsTotal = api
            ...
            // Update footer
			$( api.column( 2 ).footer() ).html(Math.round(penaltyTotal,2));
			$( api.column( 3 ).footer() ).html(Math.round(serviceChargesTotal,2));
			$( api.column( 4 ).footer() ).html(Math.round(insuranceChargeTotal,2));
			$( api.column( 5 ).footer() ).html(Math.round(loanSavingsTotal,2));
    }
	});	
}
setTimeout(function()
...
<div class="content-wrapper">
        ...
        <section class="content-header" id="addLoan">
          <h1>&nbsp;          </h1>
          <ol class="breadcrumb">
            <li><b><a href="addIncome.php"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Income </a></b></li>
          </ol>
        </section>	
                  ...
                  <table id="example" class="table table-bordered table-striped " cellspacing="0" width="100%">
                    <thead>
                      <tr>
						...
						<th class="col-md-1">Service Charges</th>
						<th class="col-md-1">Insurance Charges</th>
						<th class="col-md-1">Loan Savings</th>
					...
					{
						$query="SELECT * FROM income_expenses where type='Income' and deleted='0' order by id Desc LIMIT 20";
					}	
